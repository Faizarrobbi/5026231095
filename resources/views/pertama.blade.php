<html>
    ...
    <body>
        ...
        <hr>
        <strong>
            Ini juga nyoba. Tapi lebih strong
        </strong>
        <hr>
        <em>
            Ini juga nyoba. Tapi di empasis
        </em>
        <hr>
        <b>
            Bold ada 2. Bisa pake "b", bisa pake strong. Tebelnya sama
        </b>
        <hr>
        <br>
        <div class="row">
            <div class="column">
                <img src="materialC/AC7.png" style="width:100%">
            ...
            <div class="column">
                ...
                <img src="materialC/Minecraft.png" style="width:100%">
            </div>
        </div>
        <div class="example">
